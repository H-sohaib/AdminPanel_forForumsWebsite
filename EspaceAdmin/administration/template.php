          ...
          <table cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
              <td class="hide-for-mobile"  height="150" valign="top" >
                <b>
                  <span>Forum Toulouse Technologies</span>
                  </b>
                <br>
                <span>31 BD Lascrosses,Toulouse,31000</span>
              </td>
            </tr>
                  ...
                  <tr>
                    <td>
                      ...
                      <table cellspacing="0" cellpadding="10" width="100%">
                        <tr>
                          <td>
                            Hi <p><strong><?php $_SESSION['nom_admin']?></strong></p>
                          </td>
                      ...
                      <table cellspacing="0" cellpadding="10" width="100%">
                        <tr>
                          <td>
                            <b>Bienvenue à Toulouse Forum TechnologiesICICI</b><br>
                         
                            <p><strong> <?php  $_SESSION['mail_message']  ?></strong></p>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table cellspacing="0" cellpadding="10" width="100%">
                        <tr>
                          ...
                          <td width="150" style="width:300px;">
                                 ...
                                 transition: 0.4s;
                                 border-radius: 25px;
                                 background-color: rgb(207, 30, 113);">   <a href="#" style="border-radius:5px; color:white; text-decoration:none ;text-align:justify;">Acceder à mon compte!</a></button>
